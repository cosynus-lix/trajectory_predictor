...
if __name__ == "__main__":
    ...
    #model.save('../../experiments/Baseline_model/Improved_baseline','Improved_Baseline_model_scenario2')
    model.load('../../experiments/Baseline_model/Improved_baseline/Improved_Baseline_model_scenario2.pt')
    ...
    trajectory_printer.plot_trajectory_with_prediction(init+past,trajectory, prediction,name='Scenario 2 - Iterative Model')
