...
if __name__ == "__main__":
    ...
    #model.save('../../experiments/Baseline_model/Improved_baseline','Improved_Baseline_model_scenario3')
    model.load('../../experiments/Baseline_model/Improved_baseline/Improved_Baseline_model_scenario3.pt')
    ...
    trajectory_printer.plot_trajectory_with_prediction(init+past,trajectory, prediction,name='Scenario 3 - Iterative Model')
