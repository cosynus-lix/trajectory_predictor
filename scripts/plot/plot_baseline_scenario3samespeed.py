...
if __name__ == "__main__":
    ...
    #model.save('../../experiments/Baseline_model/Baseline','Baseline_model_scenario3')

    #Load data

    model.load('../../experiments/Baseline_model/Baseline/Baseline_model_scenario3.pt')
    value_to_test = 2700

    # Get series to predict

    dataset2=Dataset()
    dataset2.load_data('../../centerline/map6.csv', '../../runs/run6/spline.npy', '../../runs/run6/history.npy')
    ...
    trajectory_printer.plot_trajectory_with_prediction(past+value_to_test,trajectory, prediction,name='Scenario 3 - Baseline Model')
